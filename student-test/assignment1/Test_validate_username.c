...
void test_validate_my_username()
{
   ...
   */
    ...
    const char* conf_file_user_name = malloc_username_from_conf_file();

    const char* hardcoded_user_name = my_username();
     
    TEST_ASSERT_EQUAL_STRING(conf_file_user_name,hardcoded_user_name);
